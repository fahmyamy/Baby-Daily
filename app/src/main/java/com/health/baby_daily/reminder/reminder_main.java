...
public class reminder_main extends AppCompatActivity {
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public void onBindViewHolder(VerticalItemHolder itemHolder, int position) {
            ...
            itemHolder.setReminderTitle(item.mTitle, item.mBaby);
        ...
        public  class ReminderItem {
            ...
            public ReminderItem(String Title, String Baby, String DateTime, String Repeat, String RepeatNo, String RepeatType, String Active) {
                this.mTitle = Title;
                this.mBaby = Baby;
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = reminder_main.this;
            ...
            public void setReminderTitle(String title, String baby) {
                mTitleText.setText(title + " (" + baby + ")");
                String letter = "A";
            ...
            public void setActiveImage(String active){
                if(active.equals("true")){
                    mActiveImage.setImageResource(R.drawable.ic_notifications_on_grey_24dp);
        ...
        public List<ReminderItem> generateData(int count) {
            ...
            for (DateTimeSorter item:DateTimeSortList) {
                ...
                items.add(new ReminderItem(Titles.get(i), Babies.get(i), DateAndTime.get(i), Repeats.get(i),

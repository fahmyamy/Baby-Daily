...
public class ReminderEditActivity extends AppCompatActivity implements
    ...
    private TextView mSelectBabyText, mDateText, mTimeText, mRepeatText, mRepeatNoText, mRepeatTypeText;
    ...
    String[] babies = new String[4];
    String[] baby_id = new String[4];
    ...
    private static final String KEY_BABY = "baby_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Views
        mTitleText = (TextView) findViewById(R.id.set_event);
        mSelectBabyText = (TextView) findViewById(R.id.set_baby_select);
        ...
        */
        ...
        mBaby = mReceivedReminder.getBaby();
        ...
        mParent = mReceivedReminder.getmParent();

        // Setup TextViews using reminder values
        mTitleText.setText(mTitle);
        mSelectBabyText.setText(mBaby);
        ...
        if (savedInstanceState != null) {
            ...
            String savedBaby = savedInstanceState.getString(KEY_BABY);
            mSelectBabyText.setText(savedBaby);
            mBaby = savedBaby;
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_BABY, mSelectBabyText.getText());
        ...
        outState.putCharSequence(KEY_PARENT, mParent);
    }
    ...
    //On clicking of baby select button
    public void selectEvent(View v){
        final String[] events = new String[8];
        ...
        events[3] = "Feed";
        events[4] = "Medicine";
        events[5] = "Measurement";
        events[6] = "Vaccine";
        events[7] = "Appointment";
    ...
    //On clicking of baby select button
    public void selectBaby(View v){

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Select Baby");
        builder.setItems(babies, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int position) {
                mBaby = babies[position];
                mSelectBabyText.setText(mBaby);
            }
        });
    ...
    public void updateReminder(){
        ...
        mReceivedReminder.setBaby(mBaby);
        ...
        mReceivedReminder.setActive(mParent);

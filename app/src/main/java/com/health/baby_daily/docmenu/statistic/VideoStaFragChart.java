 ...
 */
public class VideoStaFragChart extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_video_sta_frag_chart, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                        ...
                        query_view = table_view.orderByChild("postId").equalTo(vid);
        ...
        chart.getDescription().setText("Video");
        ...
        table_sta = FirebaseDatabase.getInstance().getReference().child("Video");
        ...
        query_sta.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                        Video video = snapshot.getValue(Video.class);
                        if (video.getCreated().contains(curJan)){
                            countJan++;
                        }else if (video.getCreated().contains(curFeb)){
                            countFeb++;
                        }else if (video.getCreated().contains(curMar)){
                            countMar++;
                        }else if (video.getCreated().contains(curApr)){
                            countApr++;
                        }else if (video.getCreated().contains(curMay)){
                            countMay++;
                        }else if (video.getCreated().contains(curJun)){
                            countJun++;
                        }else if (video.getCreated().contains(curJul)){
                            countJul++;
                        }else if (video.getCreated().contains(curAug)){
                            countAug++;
                        }else if (video.getCreated().contains(curSep)){
                            countSep++;
                        }else if (video.getCreated().contains(curOct)){
                            countOct++;
                        }else if (video.getCreated().contains(curNov)){
                            countNov++;
                        }else if (video.getCreated().contains(curDec)){
                            countDec++;
                        }
                    }

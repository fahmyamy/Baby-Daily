...
import com.health.baby_daily.docmenu.createPost.ImageUpload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Gallery.this, ImageUpload.class));
            }
        });
        ...
        adapter.setOnItemClickListener(new GalleryPostAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                intent.putExtra("image_url", list.get(position).getImage());

...
public class Video extends Fragment {
    ...
    private List<com.health.baby_daily.model.Video> videoList;
    private String uid;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()){
                            for (DataSnapshot snapshot: dataSnapshot.getChildren()){
                                com.health.baby_daily.model.Video video = snapshot.getValue(com.health.baby_daily.model.Video.class);

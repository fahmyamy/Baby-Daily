...
public class DiaperSta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diaper_sta);
        ...
        frag.replace(R.id.fragmentLayout, new DiaperStaFragList());
        frag.commit();
        ...
        btnList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment list = new DiaperStaFragList();
        ...
        btnChart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Bundle bundle = new Bundle();
                //bundle.putString("bId", bId);
                Fragment chart = new DiaperStaFragChart();
        ...
        if (id == R.id.action_share){
            ...
            inAppShare.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    //inAppShare
                    String shareBody = "https://babydaily-a6e5a.firebaseapp.com/diaper/index.html?baby_id="+ bId + System.lineSeparator() +"Hey try this out!!";
                    Intent shareIntent = new Intent(DiaperSta.this, ContactList.class);

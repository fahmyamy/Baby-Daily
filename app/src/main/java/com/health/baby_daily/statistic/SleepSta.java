...
public class SleepSta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sleep_sta);
        ...
        frag.replace(R.id.fragmentLayout, new SleepStaFragList());
        frag.commit();
        ...
        btnList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment list = new SleepStaFragList();
        ...
        btnChart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Bundle bundle = new Bundle();
                //bundle.putString("bId", bId);
                Fragment chart = new SleepStaFragChart();
        ...
        if (id == R.id.action_share){
            ...
            inAppShare.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    //inAppShare
                    String shareBody = "https://babydaily-a6e5a.firebaseapp.com/sleep/index.html?baby_id="+ bId + System.lineSeparator() +"Hey try this out!!";
                    Intent shareIntent = new Intent(SleepSta.this, ContactList.class);

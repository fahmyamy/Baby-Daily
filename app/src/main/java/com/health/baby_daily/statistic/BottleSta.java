...
import com.health.baby_daily.chatroom.ChatInfo;
import com.health.baby_daily.contact.ContactList;
import com.health.baby_daily.model.Baby;

import java.util.Objects;

public class BottleSta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottle_sta);
        ...
        frag.replace(R.id.fragmentLayout, new BottleStaFragList());
        frag.commit();
        ...
        btnList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment list = new BottleStaFragList();
        ...
        btnChart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Bundle bundle = new Bundle();
                //bundle.putString("bId", bId);
                Fragment chart = new BottleStaFragChart();
        ...
        if (id == R.id.action_share){
            ...
            inAppShare.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    //inAppShare
                    String shareBody = "https://babydaily-a6e5a.firebaseapp.com/bottle/index.html?baby_id="+ bId + System.lineSeparator() +"Hey try this out!!";
                    Intent shareIntent = new Intent(BottleSta.this, ContactList.class);

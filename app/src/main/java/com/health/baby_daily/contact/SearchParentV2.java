...
public class SearchParentV2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_parent_v2);
        ...
        mAdapter.setOnItemClickListener(new SearchParentAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(SearchParentV2.this, SearchedProfileV2.class);
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.exists()) {
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                    ...
                                    if (currrole.equals("Mother") || currrole.equals("Father")){
                                        if (user.getRole().equals("Doctor") && !user.getId().equals(curruid)) {
                                            userList.add(user);
                                        }
                                    }else if (currrole.equals("Doctor")){
